...
for microstructure in microstructures[-9:]:
    ...
    C_bar, tau_theta, A_bar, tau_xi, D_xi, D_theta, A0, A1, C0, C1 = compute_tabular_data(samples, mesh, plastic_modes, temperatures)
    ...
    print('A_bar/A0/A1 error:', np.linalg.norm(vol_frac0 * A0 + vol_frac1 * A1 - A_bar) / np.linalg.norm(A_bar))
